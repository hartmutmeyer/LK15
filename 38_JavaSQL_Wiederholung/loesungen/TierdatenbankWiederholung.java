...
public class TierdatenbankWiederholung extends JFrame {
	...
	public TierdatenbankWiederholung(final String title) {
		super(title);
		createGUI();
	}
	...
	private void datenbankLoeschen() {
		...
		textField_Nachname.setText("");
		if (ergebnis == 1) {
			System.out.println("Der Besitzer mit der ID " + besitzerID
					+ " wurde gelöscht.");
		} else {
			System.out.println("Einen Besitzer mit dieser ID gibt es nicht!");
		}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					TierdatenbankWiederholung frame = new TierdatenbankWiederholung("Haustier-Datenbank: Wiederholung");
